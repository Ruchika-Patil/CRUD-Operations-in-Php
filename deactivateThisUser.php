...
<head>
  ...
  <title>
  FIRST CRUD - Deactivate This Record
  </title>
...
<form name="deactivateThisUser" method="post" action="processDeactivateUser.php">
<table class="table-style-three">
  <?php foreach ($foundUser  as $userdetails) { ?>
      ...
      <tr><td>Active : </td>        <td><input type="text" name="active" value="<?php print $userdetails['active'];?>" readonly></td></tr>
  <?php } ?>
</table>
    <br/>
<div align="center">
